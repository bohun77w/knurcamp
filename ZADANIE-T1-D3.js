...
function zakupy(balansPortfela, towary) {
    ...
    {
      let a = Math.floor (balansPortfela/ towar.koszt) //Ilę mogę maksymalnie wziąć względem balansu 
       a= Math.min (a, towar.liczbaSztuk)   //Dobieram maksymalną dostępną ilość 
        balansPortfela = balansPortfela - (a * towar.koszt) //Od wartości balansu odejmuje wartość zakupionego towaru
  }
